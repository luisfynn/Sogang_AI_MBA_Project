...
if __name__ == "__main__":
    ...
    total_calory, total_carbon, total_protein, total_fat, total_natrium = total_nutrition
    ...
    output = {
        ...
        'weight_loss_predictions': [total_calory] * 14  # Placeholder for weight loss predictions
    }
