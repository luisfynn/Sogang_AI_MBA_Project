...
# json_dir = r'C:\python\pythonProject_pra\labeling'
#
...
#
# # 폴더 정의
# train_dir = r'C:\python\pythonProject_pra/train'
# val_dir = r'C:\python\pythonProject_pra/val'
...
model = torch.hub.load('ultralytics/yolov5', 'custom', path= r'yolov5s.pt')
...
# 이미지 로드 및 예측
img = r'C:\python\pythonProject_pra\train\Img_134_0004.jpg'  # 예측할 이미지의 경로
results = model(img)
...
labelConverter = {'galbi':'갈비', 'galbitang':'갈비탕', 'galchi':'갈치구이', 'bowl': '그릇'}
...
calorie_dict = load_calorie_data(r'C:\Users\user\Desktop\Study\sogang\FinalProject\fooddb_20240416.xlsx')
# print("-------------------------")
